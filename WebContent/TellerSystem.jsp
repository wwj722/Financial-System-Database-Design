...
<body>
	...
	<br>
	<br>
	<form action="TellerSearchServlet" method="get">
		<div class="dca">
			<table>
				<tbody>
					<tr>
						...
						<td><span style="position: auto; border: 1px margin-top:-5px">
								<select name="category" class="t_aera">
									...
									<option value="OtherExpenditure">Other Expenditure</option>
									<option value="BorrowMoney">Borrow Money</option>
	...
	<div class="dbu"
		...
		<button onclick="{location.href='TellerChoose.jsp'}" type="button"
