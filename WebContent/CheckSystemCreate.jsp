...
<body>
	...
	<div>
		<p align=right>
			<a href="CheckoutSystem.jsp" class="one">Return</a> <a href="index.jsp"
				class="one">Logout</a>
		</p>
	</div>
	<br>
	...
	<br>
	<br>
	<form action="CreateNewConnectionServlet" method="get">
		<div class="dca">
			<table>
				<tbody>
					<tr>
						...
						<td><span style="position: auto; border: 1px margin-top:-5px">
								<select name="category" class="t_aera">
									<option value="salarycheck">Salary Check</option>
									<option value="OtherExpenditureCheck">Other
										Expenditure Check</option>
									<option value="BorrowCheck">Borrow Money Check</option>
									<option value="OtherIncomeCheck">Other Income Check</option>
							</select>
						</span></td>
					</tr>
		...
		<div class="dbu"
			...
			<button type="submit" name="" value="" class="css3button">Create</button>
