...
public class ModifyAuthority {

	static Connection currentCon = null;
	static ResultSet rs = null;
	
	public static AuthorityBean modify(AuthorityBean bean){
		...
		String UpdateQuery = "update User set authority='"
				+ authority
				+ "'where username ='"
				+ username
				+ "'and department='"
		...
		try{
			...
			//if update successfully, set the isValid variable to true, or false
			if(!more)
			{
